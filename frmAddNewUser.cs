...
namespace DVLD_Project
{
    public partial class frmAddNewUser : Form
    {
        ...
        private int _ID;
        AddUserSecondPage AddUserSecondPage = new AddUserSecondPage();
        ...
        {
            AddUserSecondPage = new AddUserSecondPage(_ID);
            panel1.Controls.Add(AddUserSecondPage);
            AddUserSecondPage.Dock = DockStyle.Fill;
            AddUserSecondPage.BringToFront();
