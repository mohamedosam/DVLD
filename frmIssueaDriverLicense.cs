...
{
    public partial class frmIssueaDriverLicense : Form
    {
        ...
        public frmIssueaDriverLicense()
        {
            InitializeComponent();
            pbClose.BringToFront();
            pbClose.Location = new Point(this.ClientSize.Width - pbClose.Width - 10, 10);
            MakeFormRounded();
            AttachClickEvent(this, true); pbClose.BringToFront();
            pbClose.Location = new Point(this.ClientSize.Width - pbClose.Width - 10, 10);
            MakeFormRounded();
            AttachClickEvent(this, true);
        }

        private void frmIssueaDriverLicense_Load(object sender, EventArgs e)
        {
